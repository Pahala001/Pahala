...
<head>
    ...
    <title>Data Siswa - Del Mobile Application</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Pengguna Del Mobile Application</h2>
                                <hr>
                                <p class="card-text"> Jumlah Siswa yang terdaftar di Del Mobile Application sekarang adalah <span
