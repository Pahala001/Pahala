...
<head>
    ...
    <title>Update Data Pengajar - Del Mobile Application</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Pengajar</h2>
                                <hr>
                                <p class="card-text"> Update data siswa meliputi Email dan Nama Lengkap.
                                    Kita tidak bisa mengubah password pengajar, Hanya pengajar yang dapat mengubah passwordnya
                                    sendiri.
                                </p>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/Pengajar_edit')?>">
                                ...
                                <div class="form-group" id="detail">
                                    ...
                                    <input id="nama" type="text" value="<?=$u->nama_pengajar?>" class="form-control"
                                        name="nama">
