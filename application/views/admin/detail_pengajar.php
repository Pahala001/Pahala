...
<head>
    ...
    <title>Data Detail Pengajar - Del Mobile Application </title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Detail Pengajar | <?=$detail->nama_pengajar?> </h2>
                            <hr>
                            <p class="card-text"> Detail Pengajar meliputi NIP, Nama, Photo, E-mail dan Date
                                Created.
                    ...
                    <div id="detail" class="col-md-12 bg-white p-3"
                        ...
                        <h1 class="font-weight-bold card-title text-center" style="color: black;">Detail Pengajar </h1>
                        ...
                        <table style="width: 100%" class="container text-center">
                            <tbody>
                                ...
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Nama Pengajar :</span></td>
                        ...
                        <a href="<?=base_url('admin/data_pengajar')?>" class="btn btn-success btn-block">Kembali</a>
                    </div>
                </section>
            </div>
        </div>
