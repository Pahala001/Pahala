...
<head>
    ...
    <title>Admin Dashboard - Del Mobile Application</title>
    <!-- General CSS Files -->
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('pengajar'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text">Klik tombol dibawah untuk menambah materi . Materi yang
                                    ditambahkan, akan langsung terupload di database Del Mobile Application. Dan para siswa bisa
                                    segera belajar! </p>
...
echo $data['user']['username'];
?>!</h1>
                                <p class="lead">Di halaman admin Del Mobile Application - Web Del Mobile Application<br></p>
                                <div class="mt-4">
