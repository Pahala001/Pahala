                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Update data materi meliputi Nama Pengajar, Nama Mapel dan Deskripsi
                                    Materi.
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/materi_edit')?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly id="nama_pengajar" type="text" class="form-control"
                                        value="<?=$u->nama_pengajar?>" name="nama_pengajar">
                                    <?=form_error('nama_pengajar', '<small class="text-danger">', '</small>');?>
