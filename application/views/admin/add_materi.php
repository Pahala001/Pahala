...
<head>
    ...
    <title>Tambah Data Materi - Del Mobile Application </title>
    <!-- General CSS Files -->
...
?></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Del Mobile Application</div>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div>
                            <a href="<?=base_url('admin')?>"><img
                            src="<?=base_url('assets/')?>img/logo3.png" alt=""></a>
                        </div>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_pengajar')?>">Data Pengajar</a>
                                </li>
                                <li><a class="nav-link" href="<?=base_url('admin/add_pengajar')?>">Tambah Data Pengajar</a>
                                </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Penambahan data materi dapat dilakukan oleh admin dan pengajar yang
                            ...
                            <div id="detail" class="card-body">
                                <form method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-12 bg-white"
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            action="<?=base_url('pengajar/add_materi')?>">
                                            <input type="hidden" name="id">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="inputEmail4">Nama Pengajar</label>
                                                    <input autocomplete="off" required type="text" list="nama_pengajar"
                                                        onkeyup="autofill()" id="namapengajar" name="nama_pengajar"
                                                        class="form-control">
                                                    <small>List pengajar sudah tersedia di autocomplete, kalian hanya
                                                        tinggal klik input area nya atau dengan cara menulis namanya dan
                                                        klik pengajar yang akan dipilih.</small>
                                                    <datalist id=nama_pengajar>
                                                        <?php
include "koneksi.php";
$qry = mysqli_query($koneksi, "SELECT nama_pengajar From pengajar");
while ($t = mysqli_fetch_array($qry)) {
    echo "<option value='$t[nama_pengajar]'>".$t['nama_pengajar'].'</option>';
}
?>
                                                    </datalist>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_mapel"
                                                    ...
                                                    placeholder="Pilih nama pengajar yang valid agar nama mapel muncul"
                                                    >
                                                <small>Jika nama mapel sudah berganti artinya nama pengajar yang kamu
                                                    masukan di input area adalah valid! jika tidak muncul nama mapel
                                                    anda harus klik input area nama pengajar dan pilih pengajar yang tersedia
                                                    disana.</small>
                                            </div>
                                            <div class="form-group">
        ...
        <footer class="main-footer">
            <div class="footer-left">
                Copyright &copy; 2020 <div class="bullet"></div> Code & Design by <a
                    href="https://syauqizaidan.github.io/">Team</a>
            </div>
            <div class="footer-right">
                Made with <span class="text-danger"> &#10084;</span> by Team
            </div>
        </footer>
        <!-- End Footer -->
        ...
        <script>
        function autofill() {
            var nama_pengajar = $("#namapengajar").val();
            $.ajax({
                url: '../autofill.php',
                data: "nama_pengajar=" + nama_pengajar,
            }).done(function(data) {
                var json = data,
                    obj = JSON.parse(json);
