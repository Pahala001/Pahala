        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    ...
                    <a class="dn_btn" href="mailto:learnifyedu@gmail.com">pahala.picauly@gmail.com</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item" id="navkontak"><a class="nav-link" href="<?=base_url('welcome/gallery')?>">Gallery</a>
                            </li>
