    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="http://smkn1ciamis.id/">Website Resmi Del</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?=base_url('welcome/pengajar')?>">Untuk Pengajar</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="#">Pahala Picauly Sagala</a></li>
                        <li><a href="#">Romauli Sianipar</a></li>
                        <li><a href="#">Elfrida Tampubolon</a></li>
                        <li><a href="#">Sharoon Siahaan</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Del Mobile Applcation</h4>
                <p>
                    Del Mobile Application. 
                    Club ini merupakan Sistem Informasi yang memberikan layanan mengenai Del Mobile Application. 
                    Di dalam sistem ini tim pengembang memberikan layanan untuk melihat informasi kepada pengguna.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                Made with <span class="text-danger"> &#10084;</span> by Pahala
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-dark font-weight-bold" style="color:#212529 !important;"
                    ...
                    Del Mobile Application - Masuk Sekarang</h2>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-6">
                            ...
                            <div>
                                <p class="terms">Login Untuk Admin <a href=" <?=base_url('welcome/admin')?>">
                                        disini.</a></p>
                            </div>
                        </div>
                    </div>
