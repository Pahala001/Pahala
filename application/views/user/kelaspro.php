        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400"
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! , Ini merupakan halaman mapel Del Mobile Application ! Silahkan pilih mapel yang akan kamu
                        akses
                    dan materi siap disaksikan! Selamat belajar ya students!</p>
                    <hr>
...
$data['user'] = $this->db->get_where('siswa', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama'];
?> - Del Mobile Application Students</h3>
                        <h5>Mata Pelajaran Kelas Professional</h5>
                </div>
            </div>
        </div>
    </div>
