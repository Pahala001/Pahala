...
<head>
    ...
    <title>Del Mobile Application</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="tel:+4400123654896"></a>
                    <a class="dn_btn" href="mailto:support@colorlib.com"></a>
                </div>
            </div>
        </div>
        <div class="main_menu">
        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    <h2>Pendaftaran Del Mobile Application</h2>
                    <div class="page_link">
        ...
        <div class="row bg-registration p-3">
            <div class="col-md-12 text-center">
                <p class="registration-title font-weight-bold display-4 mt-4" style="font-size: 50px;">
                    Pendaftaran Del Mobile Application</p>
