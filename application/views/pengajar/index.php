...
<head>
    <meta charset="utf-8" />
    <title>Del Mobile Application - Teacher Page</title>
...
<body
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('pengajar/add_materi')?>">
                <img alt="Logo" src="<?=base_url('assets')?>/img/logo3.png" width="90px;" />
            </a>
        </div>
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--submenu-fullheight kt-menu__item--open kt-menu__item--here"
                                aria-haspopup="true"><a href="<?=base_url('pengajar')?>" class="kt-menu__link"><i
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="<?=base_url('pengajar/add_materi')?>" class="kt-menu__link "><i
                        ...
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- ">
                            <ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
                                        href="<?=base_url('pengajar')?>" class="kt-menu__link "><span
                                ...
                                <li class="kt-menu__item  kt-menu__item--" aria-haspopup="true"><a
                                        href="<?=base_url('welcome')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Beranda</span></a></li>
                                <li class="kt-menu__item  kt-menu__item--" aria-haspopup="true"><a
                                        href="<?=base_url('welcome/tentang')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Tentang</span></a></li>
                                <li class="kt-menu__item  kt-menu__item--" aria-haspopup="true"><a
                                        href="<?=base_url('welcome/pelajaran')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Pelajaran</span></a></li>
                                <li class="kt-menu__item  kt-menu__item--" aria-haspopup="true"><a
                                        href="<?=base_url('welcome/kontak')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Kontak</span></a></li>
                                <li class="kt-menu__item  kt-menu__item--" aria-haspopup="true"><a
                                        href="<?=base_url('welcome/gallery')?>" class="kt-menu__link "><span
                                            class="kt-menu__link-text">Gallery</span></a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
                                    ...
                                    <div class="kt-user-card__name font-weight-bold">
                                        Hai!, &nbsp;<?php
$data['user'] = $this->db->get_where('pengajar', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama_pengajar'];
?>
                                    </div>
                                </div>
                                ...
                                <div class="kt-notification">
                                    <a href="<?=base_url('pengajar/add_materi')?>" class="kt-notification__item">
                                        ...
                                        <div class="kt-notification__item-details">
                                            ...
                                            <div class="kt-notification__item-time">
                                                Tambah Materi Del Mobile Application
                                            </div>
                                        </div>
                                    </a>
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Del Mobile Application</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman pengajar Del Mobile Application, anda dapat menambah materi .
                                                Dalam materi anda dapat memasukan video, dan deskripsi nya. Seemoga anda
                                                dapat menikmati Del Mobile Application!, kontak Administrator jika terjadi masalah
                                                apapun yang terkait upload materi. Terima kasih telah menggunakan
                                                Del Mobile Application!
                                                <br>
                                                Selamat Bekerja
                                            </div>
                                        </div>
                        ...
                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                            <div class="kt-footer__copyright">
                                2020&nbsp;&copy;&nbsp;<a href="https://syauqizaidan.github.io/" target="_blank"
                                    class="kt-link">Team</a>
                            </div>
                            <div class="kt-footer__menu">
                                Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by Club DMD
                            </div>
                        </div>
