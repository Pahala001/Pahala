...
<head>
    ...
    <title>Tambah Data pengajar - Del Mobile Application</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Pengajar</h2>
                                <hr>
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran Guru hanya dapat dilakukan oleh admin. Oleh karena itu, pengajar tidak dapat
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/add_pengajar')?>">
                                ...
                                <div id="" class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <select class="form-control selectric" name="mapel">
                                            <option>Dasar Pemograman</option>
                                            <option>Belajar Java</option>
                                        </select>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2020 <div class="bullet"></div> Program & Design by <a
                href="syauqizaidan.github.io">Team</a>
        </div>
