...
<head>
    <meta charset="utf-8" />
    <title>Del Mobile Application - Tambah Materi</title>
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"><a
                                    href="<?=base_url('pengajar')?>" class="kt-menu__link"><i
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input required type="text" readonly name="nama_pengajar" value="<?php
$data['user'] = $this->db->get_where('pengajar', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama_pengajar'];?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
