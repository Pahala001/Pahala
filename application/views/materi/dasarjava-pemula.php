...
<head>
    ...
    <title>Dasar Java | Kelas Pemula - Del Mobile Application</title>
    <!-- Bootstrap CSS -->
...
$data['user'] = $this->db->get_where('siswa', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama'];
?> - Del Mobile Application Students</h4>
                    <p>Dasar Java - Kelas Pemula</p>
                    <hr width="80%">
            ...
            <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                <div class="card materi w-150 border-0">
                    <div class="card-body p-5">
                        <h1 class="card-title"><?=$u->nama_pengajar;?></h1>
                        <p class=" card-text">
